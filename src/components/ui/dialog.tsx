  ...
  return (
    <DialogPrimitive.Portal>
      <DialogPrimitive.Overlay
        ...
        className="fixed inset-0 z-50 animate-fade-in bg-black/70 backdrop-blur-sm"
      />
      ...
      >
        ...
        <DialogPrimitive.Close
          className="absolute top-4 right-4 cursor-pointer rounded-sm text-muted-foreground transition-colors hover:text-foreground"
          aria-label="Fechar"
        >
